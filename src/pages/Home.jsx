...
function Home() {
    ...
    if (isAuthenticated) { 
        ...
        if (!hasRecord && investments != null ) { //has investment but not yet recorded
                ...
                <div className='my-5'>
                    ...
                    <div className="card w-96 bg-base-100 shadow-xl">
                        <div className="card-body">
                            ...
                            <button className='btn' onClick={recordInvestor}> Confirm</button>
                            </div>  
        ...
        if (!hasRecord && investments == null) { // not an investor at all 
            //show data 
            return (
                <div> 
                <div className="card w-96 bg-base-100 shadow-xl">
        ...
        if (hasRecord) { // has records already 
        ...
        return (
            <Notice type={'info'} message={'Kindly connect your wallet to see your investments.'}/>
        )
    }
